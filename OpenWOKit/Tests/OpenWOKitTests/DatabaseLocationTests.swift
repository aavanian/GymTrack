...
final class DatabaseLocationTests: XCTestCase {
    func testResolveWithICloudPrefersiCloud() {
        ...
        XCTAssertEqual(result.lastPathComponent, "openwo.sqlite")
    ...
    func testLegacyURLPointsToAppSupport() {
        ...
        XCTAssertEqual(url.lastPathComponent, "openwo.sqlite")
        XCTAssertTrue(url.path.contains("Application Support"))
        XCTAssertTrue(url.path.contains("OpenWO"))
    }
}
...
final class DatabaseMigrationToCloudTests: XCTestCase {
    func testMigrationMovesFile() throws {
        ...
        let sourceFile = sourceDir.appendingPathComponent("openwo.sqlite")
        ...
        let targetFile = targetDir.appendingPathComponent("openwo.sqlite")
