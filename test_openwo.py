"""Tests for openwo.py CLI operations."""
...
class TestResolveWorkout(unittest.TestCase):
    ...
    def test_exact_match(self):
        row = openwo.resolve_workout(self.conn, "Day A")
        self.assertEqual(row["name"], "Day A")

    def test_substring_unique(self):
        row = openwo.resolve_workout(self.conn, "y A")
        self.assertEqual(row["name"], "Day A")

    def test_substring_ambiguous_exits(self):
        with self.assertRaises(SystemExit):
            openwo.resolve_workout(self.conn, "Day")
...
class TestSwap(unittest.TestCase):
    def setUp(self):
        ...
        self.db_file.close()
        # Reset backup state
        openwo._backup_done = True  # skip backup for tests
    ...
    def test_swap_marks_old_inactive_and_inserts_new(self):
        ...
        openwo.cmd_swap(self.conn, args, self.db_path)
...
class TestReorder(unittest.TestCase):
    ...
    def _reorder(self, move: int, to: int):
        ...
        openwo.cmd_reorder(self.conn, args, self.db_path)
...
class TestAdd(unittest.TestCase):
    ...
    def test_add_appends_at_end(self):
        ...
        openwo.cmd_add(self.conn, args, self.db_path)
...
class TestRemove(unittest.TestCase):
    ...
    def test_remove_marks_inactive_and_shifts(self):
        ...
        openwo.cmd_remove(self.conn, args, self.db_path)
